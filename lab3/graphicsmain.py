...
class GameGraphics:
    def __init__(self, game: Game):
        ...
        # open the window
        self.win = GraphWin("Cannon game", 840, 880, autoflush=False)
    ...
    def drawCanon(self, playerNr):
        ...
        r = Rectangle(
            Point(
                player.getX() - self.game.getCannonSize()/2,
                0
            ),
            Point(
                player.getX() + self.game.getCannonSize()/2,
    ...
    def drawScore(self, playerNr):
        # draw the score
        player = self.game.getPlayers()[playerNr]
        score = Text(Point(player.getX(), -5),
    ...
    def fire(self, angle, vel):
        ...
        # Create and draw a new circle with the coordinates of
        # the projectile.
        circle = Circle(Point(circle_X, circle_Y),
                        self.game.getBallSize())
    ...
    def updateScore(self, playerNr):
        ...
        self.draw_scores[playerNr].setText('Score: {}'.format(self.game.getPlayers()[playerNr].getScore()))
